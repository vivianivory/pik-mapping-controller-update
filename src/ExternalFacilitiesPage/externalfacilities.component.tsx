...
import bulletuph from "../assets/externalbullets/uph.png";
  ...
  render(): React.ReactNode {
    ...
    return (
      <Switch>
            ...
            <div className="page-contents">
              <div className="top-menu">
                <div className="tophanging-menu external-menu-bullet">
                  <Button
                    id="logo-softer"
                    className="main-circle-button"
                    onClick={() => this.loadPage(`/internalfacilities`)}
                  >
              ...
              <div className="middle-menu external-menus">
                <div className="external-left-group-menus">
                  <div className="three-menus-column">
                    <Button
                      className="external-buttons click-effect"
                      onClick={() =>
                        this.loadPagewithAnimation(`${externalpath}/details/1`)
                      }
                    >
                    ...
                    <div className="external-menu-bullet">
                      <Button
                        className="external-buttons click-effect"
                        onClick={() =>
                          this.loadPagewithAnimation(
                            `${externalpath}/details/2`
                          )
                        }
                      >
                        <div className="external-menu-bullet">
                  ...
                  <div className="three-int-menus-column prasmul">
                    ...
                    <div className="external-menu-bullet prasmul">
                      <div className="external-menu-bullet prasmul">
                        <img alt="bulletuph" src={bulletuph} />
                      </div>
                    </div>
                    <div className="external-menu-bullet">
                      <Button
                ...
                <div className="external-right-group-menus">
                  <div className="three-int-menus-column">
                    <div className="external-menu-bullet">
                      <Button
                        className="external-buttons click-effect"
                        onClick={() =>
                          this.loadPagewithAnimation(
                            `${externalpath}/details/5`
                          )
                        }
                      >
                        <div className="external-menu-bullet">
        ...
        <Route
          path={`${externalpath}/details/:detailIndex`}
          component={ExternalFacilitiesDetail}
        />
      </Switch>
    );
  }
