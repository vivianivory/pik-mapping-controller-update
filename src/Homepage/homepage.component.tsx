...
import videobtn from "../assets/homepagemenus/video.png";
        ...
        <div className="page-contents homepage-content">
          <div className="homepage-menus-wrapper">
            <div className="homepage-menus-column first-column">
              ...
              <Button
                className="homepage-buttons"
                onClick={() => this.loadPage(`/information`)}
              >
                <div className="homepage-menu-bullet">
            ...
            <div className="homepage-menus-column second-column">
              <Button
                className="homepage-buttons"
                onClick={() => this.loadPage(`/externalfacilities`)}
              >
                <div className="homepage-menu-bullet">
              ...
              <Button
                className="homepage-buttons"
                onClick={() => this.loadPage(`/video/progress`)}
              >
                <div className="homepage-menu-bullet">
                  <img alt="animation-button" src={videobtn} />
                </div>
              </Button>
            </div>
            <div className="homepage-menus-column third-column">
              ...
              <Button
                className="homepage-buttons"
                onClick={() => this.loadPage(`/unittype`)}
              >
                <div className="homepage-menu-bullet">
